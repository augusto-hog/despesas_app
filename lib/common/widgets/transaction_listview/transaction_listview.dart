...
import 'package:despesas_app/common/widgets/transaction_listview/transaction_listview_state.dart';
...
class _TransactionListViewState extends State<TransactionListView> with CustomModalSheetMixin, CustomSnackBar {
  final _scrollController = ScrollController();
  final _transactionListViewController = locator.get<TransactionListViewController>();
  ...
  void initState() {
    ...
    _scrollController.addListener(() {
      if (widget.onLoading != null) {
        widget.onLoading!(_scrollController.position.pixels == _scrollController.position.maxScrollExtent);
      }
    });
