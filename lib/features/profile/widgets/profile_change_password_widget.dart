...
class _ProfileChangePasswordWidgetState extends State<ProfileChangePasswordWidget> with CustomSnackBar {
  ...
  void handlePasswordChange() {
    if (_formKey.currentState != null && _focusNode.hasFocus) {
      widget._profileController.toggleButtonTap(_formKey.currentState?.validate() ?? false);
    }
  }
  ...
  Future<void> onNewPasswordSavePressed() async {
    ...
    await widget._profileController.updateUserPassword(_textEditingController.text);
  }
