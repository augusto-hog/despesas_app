import 'package:despesas_app/common/constants/mutations/delete_transaction.dart';
...
class TransactionRepositoryImpl implements TransactionRepository {
  ...
  Future<DataResult<bool>> deleteTransaction(String id) async {
    try {
      ...
      return DataResult.failure(const ConnectionException(code: 'connection-error'));
