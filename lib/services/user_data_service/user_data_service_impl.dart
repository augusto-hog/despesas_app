...
class UserDataServiceImpl implements UserDataService {
  ...
  Future<DataResult<UserModel>> getUserData() async {
    try {
      ...
      return Future.value(DataResult.failure(const UserDataException(code: 'not-found')));
    }
  }
  ...
  Future<DataResult<bool>> updatePassword(String password) async {
    try {
      ...
      return DataResult.failure(const UserDataException(code: 'update-password'));
    }
  }
  ...
  Future<DataResult<UserModel>> updateUserName(String name) async {
    try {
      ...
      return DataResult.failure(const UserDataException(code: 'update-username'));
    }
  }
}
